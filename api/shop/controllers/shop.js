    ...
    async createShop(ctx) {
        ...
        let myNewShop = {
            ...
            address: {
                ...
                country: 'Togo',
                lat: ctx.request.body.lat.match(/lat: (\d+\.\d+)/).length > 0 ? ctx.request.body.lat.match(/lat: (\d+\.\d+)/)[1] : 0,
                long: ctx.request.body.long.match(/lng: (-?\d+\.\d+)/).length > 0  ? ctx.request.body.long.match(/lng: (-?\d+\.\d+)/)[1] : 0,
            },
            avgReview: 5,
